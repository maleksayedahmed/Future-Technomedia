                        ...
                        <div class="half-slider-img-wrap">
                            ...
                            <div class="half-slider-img fl-wrap full-height">
                                ...
                                <div class="half-slider-img-item">
                                    <div class="bg"  data-bg="{{ asset('images/bg/1.jpg') }}" data-scrollax="properties: { translateY: '250px' }" ></div>
                            ...
                            <div class="custom-inner-holder">
                                ...
                                <div class="custom-inner">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"><img src="{{ asset('images/all/1.jpg') }}" class="respimg" data-scrollax="properties: { translateY: '-170px' }" alt=""></div>
                                        <div class="col-md-4">
                                ...
                                <div class="custom-inner">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3"><img src="{{ asset('images/all/2.jpg') }}" class="respimg" data-scrollax="properties: { translateY: '270px' }" alt=""></div>
                                    </div>
                                </div>
                                <!-- custom-inner end -->
                                <!-- custom-inner -->
                                ...
                                <div class="custom-inner">
                                    <div class="row">
                                        ...
                                        <div class="col-md-4"><img src="{{ asset('images/all/1.jpg') }}" class="respimg" data-scrollax="properties: { translateY: '100px' }" alt=""></div>
                                        <div class="col-md-4">
                                            <div class="custom-inner-content fl-wrap">
                                                <h4>Complete the project "domik"</h4>
                                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. </p>
                                ...
                                <div class="slick-item">
                                    <div class="fet_pr-carousel-box">
                                        <div class="fet_pr-carousel-box-media fl-wrap">
                                            ...
                                            <a href="{{ asset('images/folio/web/slider/1.jpg') }}" class="fet_pr-carousel-box-media-zoom   image-popup"><i class="fal fa-search"></i></a>
                                        </div>
