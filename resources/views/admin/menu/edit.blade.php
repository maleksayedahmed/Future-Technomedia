...
@section('content')
    ...
    {{-- Note: Pass the $menuItem variable from your controller --}}
                ...
                <div class="card">
                    <div class="card-header bg-transparent">
                        <h5 class="card-title mb-0">
                            <i class="fas fa-edit me-2"></i> Edit Details: {{ $menuItem->title }}
                        </h5>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="order" id="order" class="form-control" value="{{ old('order', $menuItem->order) }}">
                            </div>

                            {{-- Route Name --}}
                            <div class="col-md-6 mb-3">
                                <label for="route" class="form-label">Laravel Route Name</label>
                                <input type="text" name="route" id="route" class="form-control" value="{{ old('route', $menuItem->route) }}">
                            </div>

                            {{-- Custom URL --}}
                            <div class="col-md-6 mb-3">
                                <label for="url" class="form-label">Custom URL</label>
                                <input type="text" name="url" id="url" class="form-control" value="{{ old('url', $menuItem->url) }}">
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ $menuItem->is_active ? 'checked' : '' }}>
