...
@section('content')
    <div class="container-fluid px-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0 text-gray-800">Edit Blog Post: {{ Str::limit($blog->title, 50) }}</h1>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta_description"
                                    name="meta_description" rows="2" maxlength="160">{{ old('meta_description', $blog->meta_description) }}</textarea>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3" id="publishedAtGroup"
                                style="{{ old('status', $blog->status) === 'published' ? '' : 'display: none;' }}">
                            ...
                            <div class="mt-3 p-3 bg-light rounded">
                                <h6 class="text-muted mb-2">Post Statistics</h6>
                                <div class="row text-center">
                                    <div class="col-4">
                                        <div class="h5 mb-0">{{ number_format($blog->view_count) }}</div>
                                        <small class="text-muted">Views</small>
                                    </div>
                                    <div class="col-4">
                                        <div class="h5 mb-0">{{ number_format($blog->comment_count) }}</div>
                                        <small class="text-muted">Comments</small>
                                    </div>
                                    <div class="col-4">
                                        <div class="h5 mb-0">{{ $blog->reading_time }}</div>
                    ...
                    <div class="card shadow">
                        <div class="card-body">
                            ...
                            <a href="{{ route('blogs.show', $blog->slug) }}" class="btn btn-outline-info w-100"
                                target="_blank">
