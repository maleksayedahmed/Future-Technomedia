            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    <div class="flex-1">
                        ...
                        <a href="{{ route('admin.clients.create') }}" class="btn btn-light btn-sm mb-1">
    ...
    <div class="col-xl-6 col-md-12">
        <div class="card h-100">
            ...
            <div class="card-body">
                ...
                <small class="text-muted">Configure site-wide settings including social links, contact info, and general site information.</small>
            </div>
        </div>
    </div>
</div>
