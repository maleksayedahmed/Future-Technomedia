            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            @if($project->live_url)
                                <a href="{{ $project->live_url }}" target="_blank" class="btn btn-sm btn-outline-primary me-2">
                            ...
                            @if($project->video_url)
                                <a href="{{ $project->video_url }}" target="_blank" class="btn btn-sm btn-outline-danger">
                    ...
                    @if($project->pdf_file)
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <a href="{{ asset('storage/' . $project->pdf_file) }}" target="_blank" class="btn btn-sm btn-outline-danger">
                    ...
                    @if($project->hasFixedPrice())
                        ...
                        @if($project->discount_amount)
                            ...
                            <div class="mb-3">
                                ...
                                <span class="ms-2 text-success fw-bold">${{ number_format($project->getDiscountedPrice(), 2) }}</span>
                            </div>
                        @endif
                    @endif
                </div>
                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        @foreach($project->pricingPlans as $plan)
                            <div class="border rounded p-3 mb-3 {{ $plan->is_popular ? 'border-primary bg-light' : '' }}">
                                @if($plan->is_popular)
