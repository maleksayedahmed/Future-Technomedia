                ...
                <div class="col-lg-8">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <label for="video_file" class="form-label">Project Video (optional)</label>
                            ...
                            <div class="mb-3">
                                ...
                                @error('video_poster')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                <div class="form-text">Poster image shown before video plays (JPG/PNG/WebP, Max 5MB)</div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('pricing_type') is-invalid @enderror" id="pricing_type"
                                    ...
                                    <option value="none" {{ old('pricing_type') === 'none' ? 'selected' : '' }}>No Price
                                    </option>
                                    <option value="fixed" {{ old('pricing_type') === 'fixed' ? 'selected' : '' }}>Fixed
                                        Price</option>
                                    <option value="plans" {{ old('pricing_type') === 'plans' ? 'selected' : '' }}>Pricing
                                        Plans</option>
                                </select>
                                @error('pricing_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('discount_type') is-invalid @enderror"
                                                ...
                                                <option value="percentage"
                                                    ...
                                                    Percentage</option>
                                                <option value="amount"
                                                    {{ old('discount_type') === 'amount' ? 'selected' : '' }}>Amount
                                                </option>
                                            </select>
                                            @error('discount_type')
                                                <div class="invalid-feedback">{{ $message }}</div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control feature-icon-input" name="features[${featureIndex}][icon]" placeholder="e.g., fa fa-address-book">
                                <button type="button" class="btn btn-outline-secondary icon-picker-trigger">Browse</button>
                            </div>
                            <div class="form-text">Font Awesome class, e.g., <code>fa fa-address-book</code> or <code>fas fa-star</code>. Click Browse to pick.</div>
                        </div>
                    </div>
                    <div class="col-md-8">
                        <div class="mb-3">
